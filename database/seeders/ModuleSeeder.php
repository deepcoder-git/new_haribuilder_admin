...
final class ModuleSeeder extends Seeder
{
    ...
    private function adminModules(): array
    {
        return [
            ...
            [
                'unique_name' => 'admin.returns',
                'name' => 'Returns',
                'icon' => '<i class="fa-solid fa-rotate-left"></i>',
                'index_route' => 'admin.returns.index',
                'sub_routes' => [
                    'admin.returns.index',
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        'unique_name' => 'admin.reports.wastage-report',
                        'name' => 'Wastage Report',
                        'icon' => '<i class="fa-solid fa-trash"></i>',
                        'index_route' => 'admin.reports.wastage-report',
                        'sub_routes' => [
                            'admin.reports.wastage-report',
                        ],
                        'order' => 3,
                        'is_active' => true,
                        'children' => [],
                    ...
                    [
                        'unique_name' => 'admin.reports.return-report',
                        'name' => 'Return Report',
                        'icon' => '<i class="fa-solid fa-rotate-left"></i>',
                        'index_route' => 'admin.reports.return-report',
                        'sub_routes' => [
                            'admin.reports.return-report',
                        ],
                        'order' => 4,
                        'is_active' => true,
                        'children' => [],
