    ...
    <div class="card-header border-0 pt-6">
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
                <i class="fa-solid fa-ruler position-absolute ms-4" style="color: #1e3a8a;"></i>
                <h2 class="text-gray-800 fw-bold mb-0 ms-10">View Unit</h2>
            </div>
        </div>
        <div class="card-toolbar">
            <a href="{{ route('admin.units.edit', $unit->id) }}" class="btn btn-primary me-2" style="background: #1e3a8a; border: none;">
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-8">
                        <div class="mb-3" style="line-height: 2.5;">
                            ...
                            <span class="text-gray-800 fw-bold fs-6">{{ $unit->name ?? 'N/A' }}</span>
                        </div>
                        <div class="mb-3" style="line-height: 2.5;">
